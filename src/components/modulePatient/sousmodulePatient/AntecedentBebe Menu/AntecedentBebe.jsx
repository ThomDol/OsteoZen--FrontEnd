              ...
              <div>
                <div className="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      setParalysieObstetricaleDuPlexusBrachial(true)
                    }
                  />
                  <label
                    className="form-check-label"
                ...
                <div className="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      setParalysieObstetricaleDuPlexusBrachial(false)
                    }
                  />
                  <label
                    className="form-check-label"
